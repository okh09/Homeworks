...
public class Main {
    ...
    public void singleThread() {
        ...
        System.out.println("Время выполнения при однопоточных вычислениях: " + (System.currentTimeMillis() - a));
    }
    ...
    public void multiThread() {
        ...
        System.out.println("Время выполнения при многопоточных вычислениях: " + (System.currentTimeMillis() - a));
    }
